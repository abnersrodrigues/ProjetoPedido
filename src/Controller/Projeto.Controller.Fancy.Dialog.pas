unit Projeto.Controller.Fancy.Dialog;
...
const
    ...
    ColorRed : Cardinal = $FFFF0900;
    ColorGray : Cardinal = $FFAAAAAA;
    ColorBlue : Cardinal = $FF0606FC;
...
begin
    ...
    LabelMensagem.TextSettings.WordWrap := true;
    ...
    LabelTitulo.TextSettings.WordWrap  := true;
...
begin
    ...
    // Abner 29/04/2024
    if LabelBtn1.Text = 'Sim' then
      RectBtn1.Fill.Color := ColorRed
    else
      RectBtn1.Fill.Color := ColorBlue;
    RectBtn2.Fill.Color := ColorBlue;
